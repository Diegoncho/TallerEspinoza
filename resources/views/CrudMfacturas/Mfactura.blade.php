        ...
        <div class="col-md-12">
            <div class="panel panel-default" style="min-width: 800px">
                ...
                <div class="panel-body">
                    <form  action="{{ route('Mfactura') }}" class="navbar-form navbar-left pull-right" method="GET" role="search">
                    ...
                    <a href="{{ route('MfacturaAdd') }}" class="btn btn-primary">Registrar nuevo comprobante</a>
                ...
                <table class="table table-striped">
                    ...
                    @foreach($model as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('MfacturaDetail', $row->id) }}">
                            ...
                            <td class="text-right">
                                <a href="{{ route('MfacturaPdf', $row->id) }}"class="btn btn-success btn-block btn-xs">
